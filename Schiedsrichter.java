...
public class Schiedsrichter {
 ...
 public void spielStarten() {
    ...
    if (this.spieler1.getDarfWuerfeln() == false && this.spieler2.getDarfWuerfeln() == false && this.nichtBeginner == null) {
...
// Methode zum Auswerten des Spiels
 public void Auswerten(){
    ...
    if (this.spieler1.punktestandAngeben() > this.spieler2.punktestandAngeben() && this.spieler1.wurfAnzahlAngeben() <= this.spieler2.wurfAnzahlAngeben()) {
    ...
    if (this.spieler2.getsiebengewuerfelt() == false) {
        ...
        if (this.spieler2.punktestandAngeben() > this.spieler1.punktestandAngeben() && this.spieler2.wurfAnzahlAngeben() <= this.spieler1.wurfAnzahlAngeben()) {
